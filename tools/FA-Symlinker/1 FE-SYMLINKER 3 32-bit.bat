set FEman=
@echo off
delete the next 7 lines if you want to move Fable Explorer or this script
SET fed=%cd%
echo %fed%>%cd%\fed.txt
set /p fableexplorer=<fed.txt
del %cd%\explorerDIR.txt
cd %Output%
...
cls
cd C:\Program Files\Microsoft Games\Fable - The Lost Chapters
@echo off
...
goto autoloaddirs
:MAINMENU
mkdir "C:\Program Files\Microsoft Games\Fable - The Lost Chapters"
clear
cd C:\Program Files\Microsoft Games\Fable - The Lost Chapters
@echo off
echo %fableexplorer%>%Output%\explorerDIR.txt
...
:defdirs
set fabletlc= C:\Program Files\Microsoft Games\Fable - TLC
set fableanni= C:\Program Files\Steam\steamapps\common\Fable Anniversary
set fableexplorer=
goto mainmenu
...
goto mainmenu
:micdir
SET fabletlc=C:\Program Files\Microsoft Games\Fable - The Lost Chapters
del %Output%\tlc.txt
echo %fabletlc%>%Output%\tlc.txt
echo saved to text file: %output% (loadable in main menu)
echo Now install symlinks (remove then install if necessary) and choose which game to edit.
...
echo Example 1: C:\Program Files\Microsoft Games\Fable - The Lost Chapters
...
echo.	---------------------
echo.	1.) Custom
echo.	2.) C:\Program Files\FableTLCMod\FableExplorer
echo.	3.) C:\Program Files\FableTLCMod\ShadowNet
set /p userinp=    ^   Make your selection: 
set userinp=%userinp:~0,1%
...
goto ftlcSETDIR
:fedir
SET fableexplorer=C:\Program Files\FableTLCMod\FableExplorer
del %Output%\explorerDIR.txt
echo %fableexplorer%>%Output%\explorerDIR.txt
echo saved to text file: %output% (loadable in main menu)
...
goto mainmenu
:shadownetdir
SET fableexplorer=C:\Program Files\FableTLCMod\ShadowNet
del %Output%\explorerDIR.txt
echo %fableexplorer%>%Output%\explorerDIR.txt
echo saved to text file: %output% (loadable in main menu)
echo Set directory: %fableexplorer%
...
:customdir2
echo paste in exact directory without backslash at the end.
echo Example: C:\Program Files\FableTLCMod\FableExplorer
